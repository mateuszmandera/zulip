...
class FetchAPIKeyLDAPTest(LDAPTestCase):
    @override_settings(AUTHENTICATION_BACKENDS=('zproject.backends.ZulipLDAPAuthBackend',))
...
class TestTwoFactorLDAP(LDAPTestCase):
...
class ZulipLDAPTestCase(LDAPTestCase):
    def setUp(self) -> None:
        super().setUp()
...
class TestZulipLDAPUserPopulator(ZulipLDAPTestCase):
    ...
    def test_update_full_name(self) -> None:
        self.change_user_attr('hamlet', 'cn', 'New Name')
    ...
    def test_update_split_full_name(self) -> None:
        self.change_user_attr('hamlet', 'cn', 'Name')
        self.change_user_attr('hamlet', 'sn', 'Full')
    ...
    def test_too_short_name(self) -> None:
        self.change_user_attr('hamlet', 'cn', 'a')

        with self.assertRaises(ZulipLDAPException):
            self.perform_ldap_sync(self.example_user('hamlet'))

    def test_deactivate_user(self) -> None:
        self.change_user_attr('hamlet', 'userAccountControl', '2')
    ...
    def test_update_user_avatar(self) -> None:
        ...
        self.change_user_attr('hamlet', 'jpegPhoto', static_path("images/logo/zulip-icon-512x512.png"),
                              binary=True)
        with mock.patch('zerver.lib.upload.upload_avatar_image') as fn, \
            self.settings(AUTH_LDAP_USER_ATTR_MAP={'full_name': 'cn',
                                                   'avatar': 'jpegPhoto'}):
    ...
    def test_update_user_avatar_for_s3(self) -> None:
        ...
        self.change_user_attr('hamlet', 'jpegPhoto', test_image_data)
        with self.settings(AUTH_LDAP_USER_ATTR_MAP={'full_name': 'cn',
                                                    'avatar': 'jpegPhoto'}):
            self.perform_ldap_sync(self.example_user('hamlet'))
        ...
        self.change_user_attr('hamlet', 'jpegPhoto', b'00' + test_image_data)
        with self.settings(AUTH_LDAP_USER_ATTR_MAP={'full_name': 'cn',
                                                    'avatar': 'jpegPhoto'}):
            with mock.patch('logging.warning') as mock_warning:
                self.perform_ldap_sync(self.example_user('hamlet'))
    ...
    def test_update_custom_profile_field_invalid_data(self) -> None:
        self.change_user_attr('hamlet', 'birthDate', '9999')
