...
def get_modern_user_info(last_active_time: datetime.datetime,
                         last_connected_time: datetime.datetime) -> Dict[str, Any]:
    # TODO: Do further bandwidth optimizations to this structure.
    result = dict()
    result['active_timestamp'] = last_active_time
    result['idle_timestamp'] = last_connected_time
    return result

def get_legacy_user_info(last_active_time: datetime.datetime,
                         last_connected_time: datetime.datetime) -> Dict[str, Any]:
