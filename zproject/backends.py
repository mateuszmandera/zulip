...
class ZulipLDAPUser(_LDAPUser):
    ...
    def _get_group_descriptions(self) -> dict[str, str | None]:
        ...
        group_infos: list[tuple[str, dict[str, object]]] = self._groups._get_group_infos()
    ...
    def group_description_from_info(self, group_info: tuple[str, dict[str, object]]) -> str | None:
