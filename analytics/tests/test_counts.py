...
class AnalyticsTestCase(ZulipTestCase):
    ...
    def setUp(self) -> None:
        super().setUp()
        self.default_realm = do_create_realm(string_id="realmtest", name="Realm Test")
        self.default_realm.date_created = self.TIME_ZERO - 2 * self.DAY
        self.default_realm.save(update_fields=["date_created"])
...
class TestCountStats(AnalyticsTestCase):
    def setUp(self) -> None:
        ...
        # the queries).
        self.second_realm = do_create_realm(string_id="second-realm", name="Second Realm")
        self.second_realm.date_created = self.TIME_ZERO - 2 * self.DAY
        self.second_realm.save(update_fields=["date_created"])
        ...
        self.no_message_realm.date_created = self.TIME_ZERO - 2 * self.DAY
        self.no_message_realm.save(update_fields=["date_created"])
