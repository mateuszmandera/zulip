...
def set_expiry_date_for_existing_confirmations(
    ...
    def backfill_confirmations_between(lower_bound: int, upper_bound: int) -> None:
        for confirmation in Confirmation.objects.filter(id__gte=lower_bound, id__lte=upper_bound):
    ...
    if last_id > id_range_lower_bound:
        # Backfill for the last batch.
        backfill_confirmations_between(id_range_lower_bound, last_id)
